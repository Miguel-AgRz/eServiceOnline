...
{
    public class ProductHaulIntegrationWithDRBTestForBlend : IntegrationTestBase
    {
        ...
        [Test]
        public void TestScheduleProductHaulbyRigJobBlend()
        {
            //Create separate Crew information for this test
            int crewId = PrepareSanjelCrewData("RigJobBlend");
            ...
            //After Scheduled a ProductHaul, check whether the associated table object is created successfully
            ...
            //After Scheduled a ProductHaul, check whether the object RigJobSanjelCrewSection is created and whether the state change meets the requirements
            ...
            //After Scheduled a ProductHaul, check whether the object BulkerCrewLog whether the state change meets the requirements
            ...
            //After Scheduled a ProductHaul, check whether the object SanjelCrewSchedule is created and whether the start and end times meet the calculation criteria
            double nEstimatedTravelTime = productHaul.EstimatedTravelTime;
            SanjelCrewSchedule currentsanjelCrewSchedule = eServiceOnlineGateway.Instance.GetSanjelCrewSchedulesByRigJobSanjelCrewSection(sanjelCrewSection);
            Assert.NotNull(currentsanjelCrewSchedule);
            Assert.AreEqual(currentsanjelCrewSchedule.StartTime, productHaul.ExpectedOnLocationTime.AddHours(-nEstimatedTravelTime));
            Assert.AreEqual(currentsanjelCrewSchedule.EndTime, productHaul.ExpectedOnLocationTime.AddHours(productHaul.EstimatedTravelTime));
        }

        [Test]
        public void TestScheduleProductHaulbyRigJobBlendByGoWithCrew()
        {
            //Create separate Crew information for this test
            int crewId = PrepareSanjelCrewData("RigJobBlendByGoWithCrew");
            ...
            //Scheduled a ProductHaul and check if the creation was successful
            ScheduleRigJobBlendProductHaul(true, false, crewId);
            ProductHaul productHaul = eServiceOnlineGateway.Instance.GetProductHaulByCrew(crewId).FirstOrDefault();
            Assert.NotNull(productHaul);
            Assert.AreNotEqual(productHaul.Id, 0);
            ...
            Assert.AreEqual(currentsanjelCrewSchedule.EndTime, rigJob.JobDateTime);
        }

        [Test]
        public void TestScheduleProductHaulbyRigJobBlendByThirdParty()
        {
            //Create separate Crew information for this test
            int crewId = PrepareThirdPartyBulkerCrewData("RigJobBlendByThirdParty");
            ...
            //Scheduled a ProductHaul and check if the creation was successful
            ScheduleRigJobBlendProductHaul(true, true, crewId);
            ProductHaul productHaul = eServiceOnlineGateway.Instance.GetProductHaulByCrew(crewId).FirstOrDefault();
            Assert.NotNull(productHaul);
            Assert.AreNotEqual(productHaul.Id, 0);
        ...
        [Test]
        public void TestScheduleProductHaulbyRigJobBlendByExistingHaul()
        {
            Assert.NotNull(callSheet);
            ...
            int crewId = PrepareSanjelCrewData("Existing");
            ...
            int newCrewId = PrepareSanjelCrewData("New");

            ScheduleRigJobBlendProductHaulByExist(false, newCrewId, productHaul.Id);

            Assert.AreNotEqual(crewId, 0);

            ProductHaul newProductHaul = eServiceOnlineGateway.Instance.GetProductHaulByCrew(crewId).FirstOrDefault();

            Assert.NotNull(newProductHaul);

            Assert.AreNotEqual(newProductHaul.Id, 0);

            Assert.AreEqual(newProductHaul.Id, productHaul.Id);

            List<ShippingLoadSheet> newShippingLoadSheets = eServiceOnlineGateway.Instance.GetShippingLoadSheetByProductHaulId(newProductHaul.Id);
            ...
            List<PodLoad> newPodLoads = eServiceOnlineGateway.Instance.GetPodLoadsByProductHaul(productHaul.Id);
        ...
        [Test]
        public void TestScheduleProductHaulbyRigJobBlendNoBulkCrewLog()
        {
            Assert.NotNull(callSheet);
            ...
            int crewId = PrepareSanjelCrewData("NoBulkCrewLog");
