...
{
    public class ScheduleProductHaulFromRigJobBlendViewModel
    {
        public ScheduleProductHaulFromRigJobBlendViewModel()
        {
        ...
        public void PopulateToModel()
        {
            ...
            this.ShippingLoadSheetModel.LoadAmount = this.ProductLoadInfoModel.Amount;

            this.ProductLoadInfoModel.LoggedUser = LoggedUser;
        }
